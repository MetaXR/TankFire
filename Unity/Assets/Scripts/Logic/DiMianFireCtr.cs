...
public class DiMianFireCtr : WDXFireCtr {
   
    public ParticleSystems FXDiMian;


    //public new void StartFireLab()
    //{
    //    Debug.Log("地面流淌火实验-------");
    //    if (tipWin != null)
    //    {
    ...
    //    }
    //    FlowDiMianFireMgr db = new FlowDiMianFireMgr();
    //    FlowDiMianFireBean bean = db.GetDataById(1);
    ...
    //    guidCtr.StartGuideDM((FlowDiMianFireBean)bean);
    //}
